...
class UserAccessSummaryDbReaderTest {
  ...
  @Test
  @Sql(statements = {
      INSERT + "('2024-01-10 11:14', '175.242.91.54', 'benelog')",
      INSERT + "('2024-01-10 11:14', '192.168.0.1', 'benelog')",
      INSERT + "('2024-01-10 11:14', '192.168.0.3', 'jojoldu')"
  }) // <3>
  void readItems(@Autowired DataSource dataSource) throws Exception {
    // given
    JdbcCursorItemReader<UserAccessSummary> reader = UserAccessSummaryComponents.buildDbCursorReader(dataSource, true);
